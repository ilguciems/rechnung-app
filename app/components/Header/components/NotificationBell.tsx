  ...
  return (
    <div className="relative" ref={containerRef}>
      <button
        ...
        ref={buttonRef}
        onClick={handleOpen}
        className="relative cursor-pointer rounded-full p-2 text-gray-600 transition-colors hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-500 dark:text-gray-300 dark:hover:bg-gray-700 dark:focus-visible:outline-gray-300"
      >
